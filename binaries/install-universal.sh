...
# ============================================================================
# Senterm Open Source - Universal One-Line Installer (macOS & Linux)
# 
# Usage:
...
echo ""
echo -e "${CYAN}${BOLD}╔══════════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}${BOLD}║     Senterm Open Source - Universal Installer                ║${NC}"
echo -e "${CYAN}${BOLD}╚══════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if ! curl -sSfL -o "${ASSET_NAME}" "${DOWNLOAD_URL}"; then
    ...
    echo "  - ${ASSET_NAME} may not be available for your platform"
    echo ""
    echo "Check available releases at:"
    echo "  ${RELEASES_URL}"
    exit 1
...
elif [[ -f "senterm-${PLATFORM}-${ARCH}/${BINARY_NAME}" ]]; then
    SOURCE_BINARY="senterm-${PLATFORM}-${ARCH}/${BINARY_NAME}"
...
if [[ -w "${INSTALL_DIR}" ]]; then
    ...
    # macOS specific: Remove quarantine and ad-hoc sign
